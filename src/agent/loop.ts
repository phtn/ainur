...
You have access to tools for reading/writing files, listing directories, searching files, running shell commands, and fetching URLs.
...
When running commands or writing files, wait for user approval. Be concise and helpful.`;
